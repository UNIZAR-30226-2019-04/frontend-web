            ...
            <b-card-body class="p-4">
              <b-form>
                ...
                <b-input-group class="mb-3">
                  ...
                  <b-form-input type="password" class="form-control" placeholder="Contraseña" autocomplete="new-password" />
                </b-input-group>
                ...
                <b-input-group class="mb-4">
                  ...
                  <b-form-input type="password" class="form-control" placeholder="Repetir contraseña" autocomplete="new-password" />
                </b-input-group>

                <b-button variant="success" block>Crear cuenta</b-button>
              </b-form>
            </b-card-body>
