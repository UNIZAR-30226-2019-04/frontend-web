  ...
  <div style="margin-top: 30px">
    ...
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block href="#" v-b-toggle.accordion-1 variant="info" style="font-size: 1.1rem; font-weight: bold; margin-top: 1%">Val. minima del vendedor</b-button>
      </b-card-header>
    ...
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1">
        <b-button block href="#" v-b-toggle.accordion-3 variant="info" style="font-size: 1.1rem; font-weight: bold;">Categorías</b-button>
      </b-card-header>
